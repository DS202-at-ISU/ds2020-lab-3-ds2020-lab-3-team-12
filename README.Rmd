...
Nina: I counted 89 total deaths — some unlucky Avengers7 are basically Meat Loaf with an E-ZPass — and on 57 occasions the individual made a comeback.
...
Lucas -> The fact-check confirms that the statement is accurate: **exactly 66.7%** of Avengers returned after their first death, and precisely **50.0%** returned from their second or third deaths, matching the original claim.

Nina: Above is my work to show fact-checking that there is a total of 89 deaths, and 57 returns. I fact checked this by using the sum function to add up the number of times the option "yes" occurs in the variable Death. Similarly, I used the sum function to add up the number of times "yes" appears in the Return column.
